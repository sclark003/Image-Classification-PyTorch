...
#-----------------MNIST-----------------#
data_dir = './MNIST_data/'
save_dir = './MNIST_results/resnet/'
#data_dir = '/content/drive/MyDrive/MNIST_data/'
#save_dir = '/content/drive/MyDrive/MNIST_results/resnet/'
...
# # #-----------------CIFAR-----------------#
# data_dir = './CIFAR_data/'
# save_dir = './CIFAR_results/resnet/'
# #data_dir = '/content/drive/MyDrive/CIFAR_data/'
# #save_dir = '/content/drive/MyDrive/CIFAR_results/resnet/'
...
# save_dir = './ImageNet_results/resnet/'
# # data_dir = '/content/drive/MyDrive/ImageNet_data/'
# # save_dir = '/content/drive/MyDrive/ImageNet_results/resnet/'
