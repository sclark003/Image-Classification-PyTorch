...
#-----------------MNIST-----------------#
data_dir = './MNIST_data/'
save_dir = './MNIST_results/inception/'
#data_dir = '/content/drive/MyDrive/MNIST_data/'
#save_dir = '/content/drive/MyDrive/MNIST_results/inception/'
...
# #-----------------CIFAR-----------------#
# data_dir = './CIFAR_data/'
# save_dir = './CIFAR_results/inception/'
# #data_dir = '/content/drive/MyDrive/CIFAR_data/'
# #save_dir = '/content/drive/MyDrive/CIFAR_results/inception/'
...
# save_dir = './ImageNet_results/inception/'
# # data_dir = '/content/drive/MyDrive/ImageNet_data/'
# # save_dir = '/content/drive/MyDrive/ImageNet_results/inception/'
...
# train_ds = Model.DSLoader(train_data,299,class_ids)
# train_loader = DataLoader(train_ds, batch_size, shuffle=True)

# val_data = te.getValData(data_dir)
# val_ds = Model.DSLoader(val_data,299,class_ids)
# val_loader = DataLoader(val_ds, batch_size, shuffle=False)
# #---------------------------------------#

# model
v = models.inception_v3(pretrained=False)
# training
model = Model.NetLogits(v)   # 10 classes
model = Model.NetLogits2(v)  # 200 classes
# # validation set
